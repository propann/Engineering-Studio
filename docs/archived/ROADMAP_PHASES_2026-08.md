# Journal des phases — archive

> **Archive.** Ce document est le journal des phases 1 à 6 tel qu'il a été tenu
> jusqu'au 26 août 2026, extrait de `docs/ROADMAP.md` le jour où celle-ci est
> devenue la feuille de route principale.
>
> Il dit ce qui était vrai **le jour où chaque entrée a été écrite**. Les
> comptes de tests qu'il cite mesurent ce que *ce changement-là* ajoutait, pas
> la taille de la suite. Ne pas s'en servir pour déclarer une fonction
> terminée : la feuille de route vivante est
> [`docs/ROADMAP.md`](../ROADMAP.md), l'état courant est
