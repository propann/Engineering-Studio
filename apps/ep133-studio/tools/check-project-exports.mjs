...
import { createDeviceClone, describeCloneDelta, DEVICE_CLONE_KEY, loadDeviceClone } from '../src/core/project/deviceProfile.ts';
...
const savedProfile = { name: 'STUDIO NOIR', capacityMb: 64, sampleFolderName: 'EP133 Samples', localSampleCount: 12, updatedAt: new Date().toISOString() };
