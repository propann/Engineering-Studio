...
const tools:Tool[]=[
 ...
 {id:"op1-exercise",code:"KEY-01",category:"TRAINING LAB",title:"Exercices OP-1",text:"Suites d’accords, clavier et retour MIDI pour progresser.",accent:"green",visual:"game",status:"OP-1 REQUIS",section:"hub",target:"hub"},
...
export default function ToolsHub(){
 ...
 function openTool(tool:Tool){
  ...
  if(tool.target==="hub"){
    ...
    if(tool.id==="op1-exercise"){(window as any).navigateMaquette("exercises-op1");return}
