      ...
      <section style={{ marginTop: "40px" }}>
        ...
        <div style={{ display: "flex", gap: "10px", marginBottom: "20px", borderBottom: "2px solid #111" }}>
          ...
          <button
            ...
            style={{
              padding: "10px 20px",
              background: activeTab === "firmware" ? "#ff5a1f" : "#ebece6",
              color: activeTab === "firmware" ? "#fff" : "#111",
              border: "none",
              cursor: "pointer",
              fontWeight: "bold"
            }}
          ...
          <button
            ...
            style={{
              padding: "10px 20px",
              background: activeTab === "editor" ? "#ff5a1f" : "#ebece6",
              color: activeTab === "editor" ? "#fff" : "#111",
              border: "none",
              cursor: "pointer",
              fontWeight: "bold"
            }}
        ...
        {activeTab === "firmware" && (
          <div style={{ padding: "20px", background: "#f9f9f9", borderRadius: "4px" }}>
            ...
            <div style={{ marginTop: "20px" }}>
              ...
              <div style={{ padding: "15px", background: "#d9ff43", border: "3px solid #111" }}>
                <strong>🔗 Ressource officielle :</strong><br />
                <a href="https://teenage.engineering/guides/op-1/original/te-boot" target="_blank" rel="noreferrer" style={{ color: "#111", textDecoration: "underline" }}>
