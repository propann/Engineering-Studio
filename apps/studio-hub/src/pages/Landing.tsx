...
export default function Home(){
 ...
 return <main>
  ...
  <section className="hero" id="top"><div className="hero-grid"/><div className="hero-copy">
   ...
   <div className="pixel-window ep-window"><div className="pixel-window-bar"><span>EP133.EXE</span><b>01</b></div><Image src="/media/teenage-engineering-ep-133-ko-ii-pixel-art-sampler.jpeg" alt="Teenage Engineering EP-133 K.O. II sampler composer en pixel art" width={2048} height={2048} priority sizes="(max-width: 900px) 62vw, 32vw"/><div className="machine-tag"><i/> EP-133 K.O. II · SAMPLER LAB</div></div>
   <div className="pixel-window op-window"><div className="pixel-window-bar"><span>OP1.EXE</span><b>02</b></div><Image src="/media/teenage-engineering-op-1-pixel-art-music-workstation.jpeg" alt="Teenage Engineering OP-1 music workstation en pixel art" width={2048} height={769} priority sizes="(max-width: 900px) 76vw, 40vw"/><div className="machine-tag"><i/> OP-1 · SYNTH STUDIO</div></div>
