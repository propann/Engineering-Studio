      ...
      <section style={{ marginTop: "40px" }}>
        ...
        <div style={{ display: "flex", gap: "10px", marginBottom: "20px", borderBottom: "2px solid #111" }}>
          <button
            ...
            style={{
              padding: "10px 20px",
              background: activeTab === "op1" ? "#ff5a1f" : "#ebece6",
              color: activeTab === "op1" ? "#fff" : "#111",
              border: "none",
              cursor: "pointer",
              fontWeight: "bold"
            }}
          ...
          <button
            ...
            style={{
              padding: "10px 20px",
              background: activeTab === "ep133" ? "#ff5a1f" : "#ebece6",
              color: activeTab === "ep133" ? "#fff" : "#111",
              border: "none",
              cursor: "pointer",
              fontWeight: "bold"
            }}
        ...
        {activeTab === "op1" && (
          <div className="doc-section" style={{ padding: "20px", background: "#f9f9f9", borderRadius: "4px" }}>
            <h2>OP-1 Studio Documentation</h2>

            <div style={{ marginBottom: "20px", padding: "15px", background: "#fff", border: "3px solid #111" }}>
