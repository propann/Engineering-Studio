...
type ToolLaunch = { id: string; machine: MachineId; tool?: "editor" | "sounds" | "services" | "game"; title: string; category: string; description: string; icon: string; color: string; action: string };
