...
export default function ToolsHub(){
 ...
 return <main className="hub-page">
  ...
  <section className="machine-studios" id="studios"><div className="machine-studio-grid">
   ...
   <Link className="machine-editor-card sound-library-card" href="/outils/bibliotheque-sons"><div className="subtool-wave">{[32,68,45,88,56,96,40,76,50,82].map((v,i)=><i key={i} style={{height:`${v}%`}}/>)}</div><div><b>SOUND-V1 · CONTENU AUDIO</b><h3>Bibliothèque de samples</h3><p>Importer, classer, écouter et préparer les banques de sons OP-1.</p></div><strong>↗</strong></Link>
  </div></section>
  ...
  <section className="utility-cards" aria-label="Accès rapides"><div className="utility-grid">
   ...
   <a className="utility-card yellow" href="/outils/sauvegardes"><span>VAULT-01</span><ToolGraphic type="chip"/><small>COFFRE LOCAL</small><h3>Sauvegarde</h3><p>Snapshots OP-1 et EP-133 avec contrôle d’intégrité.</p></a>
  </div></section>
