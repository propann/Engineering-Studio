...
const avatarLabel=(value:string)=>value.replaceAll("-"," ").toUpperCase();
 ...
 return <main className="creator-page">
  ...
  <section className="creator-layout">
   ...
   <div className="creator-console">
    ...
    <div className="creator-actions"><Link href="/">ANNULER</Link><Link className="save-profile-link" href="/outils">ENREGISTRER MA FICHE <span>→</span></Link></div>
   </div>
  </section>
 </main>
}
