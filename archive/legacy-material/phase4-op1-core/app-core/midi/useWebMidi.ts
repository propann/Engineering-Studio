...
// Ordre officiel des notes EP-133 dans un groupe : . 0 ENTER 1 2 3 4 5 6 7 8 9.
// Le projet OP-1 réutilise le mapping de l'outil EP-133 sans dépendre de son
// arborescence interne, qui n'est pas présente dans ce studio.
const PAD_MIDI_NOTES = [45, 46, 47, 42, 43, 44, 39, 40, 41, 36, 37, 38] as const;
